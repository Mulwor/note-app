...
Prototype - это свойство функции-конструктора объявленный через new, а __proto__ - свойство любого объекта, который ссылается на его прототип (на объект prototype функции-конструктора).
