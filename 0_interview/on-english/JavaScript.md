...
- 102. Какие значения в JS считаются truthy и falsy?
- 104. Какие типы данных есть в JavaScript?
- 111. Могут ли в одном массиве быть элементы разных типов?
- 120. Почему [] == false в JavaScript? Как работает сравнение?
- 125. Почему typeof null возвращает "object"?
- 133. Что возвращает typeof [] и почему?
