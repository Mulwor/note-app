...
### Темы второй недели в разработке

- [Способы создание объекта](https://it-incubator.io/prosobesim/react-frontend/roadmap?s=E72159&skill=js-es5%2Fobjects%2Fcommon%2Fways-to-create-object)
- [Получения ключей объекта](https://it-incubator.io/prosobesim/react-frontend/roadmap?s=E72159&skill=js-es5%2Fobjects%2Fcommon%2Fset-get-object-keys)
- [Опциональная цепочка и доступ к необязательным св-в](https://it-incubator.io/prosobesim/react-frontend/roadmap?s=E72159&skill=js-es6%2Fcommon%2Fdefault%2Foptional-mark-optional-chain)
...
- [Методы keys, values, entries, fromEntries](https://it-incubator.io/prosobesim/react-frontend/roadmap?s=E72159&skill=js-es6%2Fcommon%2Fdefault%2Fkeys-values-entries-methods)
