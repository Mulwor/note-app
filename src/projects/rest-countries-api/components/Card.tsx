              ...
              <div className={style.information}>
                ...
                <div className={style.additional}>
                  <div className={style.blocks}>
                    <div className={style.item}>Native Name: {country.nativeName}</div>
                    <div className={style.item}>Population: {country.population}</div>
                    <div className={style.item}>Region: {country.region}</div>
                    <div className={style.item}>Sub Region: {country.subregion}</div>
