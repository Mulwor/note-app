...
import { useAppDispath, useAppSelector, User, UserRemoveSelectedAction, UserSelectedAction } from "./store";
...
export function LessonFour() {
  ...
  const sortedUsers = useMemo(() => ids.map((id) => entities[id]).sort((a, b) => {
    if (sortType === "asc") {
