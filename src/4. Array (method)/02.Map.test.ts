import { createGreetingMessage, ManType } from "./Method";

import { CityType } from '../2. Object/02.Building';
import { getStreetTitlesOfGovernmentBuilding, getStreetTitlesOfHouses, createMessages} from "./Method";
...
test("list of streets titles of governments buildings", () => {
    let streetsNames = getStreetTitlesOfGovernmentBuilding(city.governmentBuildings);
