...
- [Многопоточность в node-js](#многопоточность)
  - [Worker threads](#worker-threads)
    - [Ключевые преимущество](#worker-threads-key-benefit)
    - [События](#worker-threads-events)
    - [Методы и свойство](#worker-threads-methods)
  - [Child process (дочерний процесс) - CP](#childProcess);
    - [Способы создания CP](#create-childProcess)
    - [Методы и свойства CP](#methods-childProcess)
