...
<details>
<summary>What kind of projects have you worked on? / What are you currently working on? / Can you walk me through your background?</summary>
...
<details>
<summary>What are your strengths and weakness (сильные и слабые стороны)</summary>

I have both a strong and a weak side. If I get an interesting and unusual task, I can't sleep until I finish it. I forget about time and can stay up late.
...
<details>
<summary>What technologies do you feel most confident with?</summary>

I specialize more in frontend development, but I don't mind writing in node-js, as I've also been enjoying working on the backend lately.

</details>

<details>
<summary>Why do you want to leave your current job? / Why are you looking for a new opportunity/job?</summary>

My contract is coming to an end, and unfortunately, the company isn't able to renew it for the next year due to financial problems

</details>

<details>
<summary>What do you know about our company?** or **Do you know anything about us?</summary>
...
<details>
<summary>What motivates you to do your best at work?</summary>

Solving real problems and complex architectural issues.

</details>

<details>
<summary>Are you open to relocation?</summary>

Yes, I'm ready. But I'd like to know upfront — would relocation be required right away, or after the probation period?

</details>

<details>
<summary>How do you handle (справляться с) conflicts at work?  </summary>

We rarely have any conflicts at work over the code, but if we did (или if we had them), I am open to criticism and the guys and I would come to a common agreement

</details>

<details>
<summary>How do you prioritize (расставляете приоритеты) tasks?</summary>

There are several options here — either our team lead or the project manager sets the priorities, and then we follow them. Speaking for myself, let's say there are 5 tasks — I sort them by importance and start with the most important ones, then move to the less important ones.

</details>

<details>
<summary>Have you ever missed a deadline? and How do you handle tight deadlines?</summary>

In my entire career, there have been a couple of times when I didn't complete a task on time. But if I can't meet a deadline, I inform the team lead or project manager about the blocker. We discuss it, and my task gets postponed for a couple of days

</details>

<details>
<summary>How do you handle (справляетесь с) stress or pressure (давлением)?</summary>

I try to relax and not panic. I take one big task, break it down into smaller ones, and solve them one by one.

</details>

<details>
<summary>Do you prefer working in a team or alone?</summary>

It doesn't matter — I can work alone or in a team. If it's a big project, I prefer to work in a team at the beginning.
...
I'm looking for more $3500 (three thousand five hundred dollars) net. But I'm flexible — if it's an interesting project, I'm willing to lower my expectations.

</details>

<details>
<summary>Are you willing (готовы) to work overtime or on weekends?</summary>

Yeah, sure — if we don't meet the deadline or we have some big main feature, I'm ready to work overtime.

</details>

<details>
<summary>What role do you usually take in a team?</summary>

I usually act as a senior developer. I look for different ways to improve the project, such as adding new libraries that speed up development.

</details>

<details>
<summary>How do you keep up with industry trends?</summary>

I created a bot that notifies me about every library update that I use. If I need a specific library, I look at the documentation and its updates. And i subscribe a different news on Telegram that says a new libraries, features or tools that can be help in my project

</details>

## What to ask on HR_INTERVIEW
...
React Fiber is a new reconciliation engine for working with the virtual DOM. Instead of using recursion, it uses a linked list, which allows rendering work to be paused, prioritized, or aborted. This makes React more responsive and improves performance — for example, when we want to handle urgent updates like user input before less urgent ones like data fetching or large list rendering.
...
- Uses Immer for safe immutability.
- configureStore() - combines reducers, adds thunk middleware

</details>

<details>
<summary>How redux works or what are action, store, reducers?</summary>

Actions describe what happened (like { type: 'INCREMENT' }). Reducers are pure functions that take the current state and an action and return a new state immutably. The store holds the global state and provides dispatch() to send actions.
...
<details>
<summary>How does it work useDispatch and useSelector under the hood</summary>

useDispatch() - it gets store from context and returns the store's dispatch function

useSelector() - it gets store from context, subscribes to state updates using useSyncExternalStore, it extract only the relevant part of the state
...
Middleware is a way to do something between when we dispatch an action and when it reaches the reducer. For example, middleware can make API requests, catch errors, add logging, handle authorization, or send analytics.
