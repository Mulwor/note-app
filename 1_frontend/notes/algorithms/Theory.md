...
<img src="./0_assets/big-o-notation.jpg" alt="Биг о нотация" width='600' />
</details>

| Big-O      | Тип сложности           | Примеры использования | Кол-в итераций на n = 10 000  |
|------------|--------------------------|-----------------------------------------| -------- |
| O(1)       | <span title="Константная сложность - код выполняется за одно и то же время, и никак не зависит от размера входных данных.">Константная</span>  | Доступ по индексу массива, <br> операции с объектами (добавление/получение свойства), <br> методы Set/Map (add, has, get), <br> математические операции (сложение, сравнение), <br> методы массивов push/pop, <br> простые условные проверки. <br> [Здесь находятся примеры](./0_big-o-notation/1_O(1).js)  | 1 |               
| O(log N)   | <span title="Логарифмическая сложность - означает, что на каждом шаге объём данных уменьшается вдвое.">Логарифмическая</span>          | Бинарный поиск и поиск в сбалансированном двоичном дереве, <br> алгоритмы "разделяй и властвуй", <br> поиск в отсортированных данных <br> [Здесь находятся примеры](./0_big-o-notation/3_O(n).js) | ~14 (так как log₂(10000) ≈ 13.3)        |
| O(N)       | <span title="Линейная сложность - время выполнения растет линейно с размером входных данных. Другими словами, чем больше входных данных (n), тем больше времени потребуется для выполнения алгоритма. Например используется в two pointers,">Линейная</span>                 |  Линейный поиск в массиве, <br> обход всех элементов массива, <br>методы shift/unshift, фильтрация массива и нахождение суммы элементов <br> [Здесь находятся примеры](./0_big-o-notation/2_O(log_N).js) |10 000                                  |
